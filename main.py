...
from plugins.functions.timers import backup_files, interval_hour_one, reset_data, update_admins, update_status
...
scheduler.add_job(interval_hour_one, "interval", hours=1)
