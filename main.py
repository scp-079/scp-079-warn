...
from plugins.functions.timers import backup_files, interval_one_hour, reset_data, update_admins, update_status
...
scheduler.add_job(interval_one_hour, "interval", hours=1)
